#tkiner is a module that holds all the functions that let us easily make GUI elements
...
btn3.grid(row = 1, column = 1 , sticky = "NESW")
...
#this line displays the root and sets the program in an infinite loop. This is an event driven program
root.mainloop()
